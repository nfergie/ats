...
$sql = "select applicant.AppID, applicant.FirstName, applicant.LastName, applicant.AppDate, stage.stagedesc, applicant.linkedin, applicant.notes  from applicant inner join stage on applicant.stageid=stage.stageid";
